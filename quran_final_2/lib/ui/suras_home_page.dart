...
import 'package:quran_final/ui/sura_details_page.dart';
                  ...
                  return ListTile(
                    ...
                    onTap: () {
                      var route = MaterialPageRoute(
                          builder: (BuildContext context) => SuraDetailsPage(
                                name: "${myData[index]['sura_name']}",
                                suraNum: "${myData[index]['sura_no']}",
                              ));
